  ...
  try {
    ...
    if (rootItem.type === "folder") {
      ...
      if (filesRes.ok) {
        const filesData = await filesRes.json();
        if (filesData.documents) {
          let traverse = function(oldParentId) {
...
// ../.wrangler/tmp/pages-4uRs4m/functionsRoutes-0.8164312514185107.mjs
var routes = [
  {
    routePath: "/api/:path*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-ttWRXz/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-ttWRXz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9592245998545819.mjs.map
