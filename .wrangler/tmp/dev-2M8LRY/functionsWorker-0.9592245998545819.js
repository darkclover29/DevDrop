...
// .wrangler/tmp/pages-4uRs4m/functionsWorker-0.9592245998545819.mjs
...
app.put("/api/file/:id", async (c) => {
  ...
  if (parentId !== void 0) payload.parentId = parentId || "";
  ...
  try {
    ...
    if (item.type === "folder") {
      ...
      if (filesRes.ok) {
        const filesData = await filesRes.json();
        if (filesData.documents) {
          let traverse = /* @__PURE__ */ __name(function(id) {
  ...
  try {
    ...
    if (rootItem.type === "folder") {
      ...
      if (filesRes.ok) {
        const filesData = await filesRes.json();
        if (filesData.documents) {
          let traverse = /* @__PURE__ */ __name(function(oldParentId) {
            ...
            for (const child of children) {
              ...
              itemsToCreate.push({
                ...
                // Stored to resolve relative IDs later
                oldParentId,
...
// .wrangler/tmp/bundle-gzmOJk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-gzmOJk/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9592245998545819.js.map
